                    ...
                    <form action="{{ route('dashboard.service.update', $service->id) }}" method="post">
                        ...
                        @foreach (config('translatable.locales') as $locale)
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="{{ $locale }}[text5]" class="form-control ckeditor">{{ $service->text5 }}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>@lang('site.' . $locale . '.النص')</label>
                                <textarea name="{{ $locale }}[text6]" class="form-control ckeditor">{{ $service->text6 }}</textarea>
                            </div>
